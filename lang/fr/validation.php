...
return [
    ...
    | la classe de validation. Certaines de ces règles ont de multiples versions telles
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Les lignes de langue suivantes sont utilisées pour échanger les
    | espaces réservés pour des attributs avec quelque chose de plus
    | convivial pour le lecteur, comme l'adresse E-Mail au lieu de
    | "email". Cela nous aide simplement à rendre les messages un
    | peu plus clairs.
    |
    */
